...
describe('KmeansOptions', () => {
    it('has clusters and iterations as optional numbers', () => {
        expectTypeOf<KmeansOptions['clusters']>().toEqualTypeOf<
            number | undefined
        >();
        expectTypeOf<KmeansOptions['iterations']>().toEqualTypeOf<
            number | undefined
        >();
    });
...
describe('FilteringOptions', () => {
    it('has alpha, brightness, and saturation as optional numbers', () => {
        expectTypeOf<FilteringOptions['alphaThreshold']>().toEqualTypeOf<
            number | undefined
        >();
        expectTypeOf<FilteringOptions['minBrightness']>().toEqualTypeOf<
            number | undefined
        >();
        expectTypeOf<FilteringOptions['maxBrightness']>().toEqualTypeOf<
            number | undefined
        >();
        expectTypeOf<FilteringOptions['minSaturation']>().toEqualTypeOf<
            number | undefined
        >();
    });
});
...
describe('PrimaryPreset', () => {
    it('is the union of four documented presets', () => {
        expectTypeOf<PrimaryPreset>().toEqualTypeOf<
            'strict' | 'balanced' | 'vibrant' | 'dominant'
        >();
    });
...
describe('SecondaryFallbackMode', () => {
    it('is the union of three documented modes', () => {
        expectTypeOf<SecondaryFallbackMode>().toEqualTypeOf<
            'harmony' | 'null' | 'nearest'
        >();
    });
...
describe('ScoringOptions', () => {
    it('has chromaFloor and grayPenalty as optional numbers', () => {
        expectTypeOf<ScoringOptions['chromaFloor']>().toEqualTypeOf<
            number | undefined
        >();
        expectTypeOf<ScoringOptions['grayPenalty']>().toEqualTypeOf<
            number | undefined
        >();
    });
});
...
describe('OutputOptions', () => {
    it('has all six output flags as optional booleans', () => {
        expectTypeOf<OutputOptions['includePalette']>().toEqualTypeOf<
            boolean | undefined
        >();
        expectTypeOf<OutputOptions['includeAccents']>().toEqualTypeOf<
            boolean | undefined
        >();
        expectTypeOf<OutputOptions['includeMetadata']>().toEqualTypeOf<
            boolean | undefined
        >();
        expectTypeOf<OutputOptions['includeLab']>().toEqualTypeOf<
            boolean | undefined
        >();
        expectTypeOf<OutputOptions['includeHsl']>().toEqualTypeOf<
            boolean | undefined
        >();
        expectTypeOf<OutputOptions['includeScores']>().toEqualTypeOf<
            boolean | undefined
        >();
    });
});
...
describe('LightnessOptions', () => {
    it('has enforceGap (boolean) and minGap (number) as optional', () => {
        expectTypeOf<LightnessOptions['enforceGap']>().toEqualTypeOf<
            boolean | undefined
        >();
        expectTypeOf<LightnessOptions['minGap']>().toEqualTypeOf<
            number | undefined
        >();
    });
});
...
describe('RemoteOptions', () => {
    it('has all six fields as optional', () => {
        expectTypeOf<RemoteOptions['timeoutMs']>().toEqualTypeOf<
            number | undefined
        >();
        expectTypeOf<RemoteOptions['maxBytes']>().toEqualTypeOf<
            number | undefined
        >();
        expectTypeOf<RemoteOptions['maxRedirects']>().toEqualTypeOf<
            number | undefined
        >();
        expectTypeOf<RemoteOptions['allowPrivateNetworks']>().toEqualTypeOf<
            boolean | undefined
        >();
        expectTypeOf<RemoteOptions['validateContentType']>().toEqualTypeOf<
            boolean | undefined
        >();
    });

    it('allowedProtocols is an optional readonly string array', () => {
        expectTypeOf<RemoteOptions['allowedProtocols']>().toEqualTypeOf<
...
describe('DecodeOptions', () => {
    it('has maxPixels and orientation as optional', () => {
        expectTypeOf<DecodeOptions['maxPixels']>().toEqualTypeOf<
            number | undefined
        >();
        expectTypeOf<DecodeOptions['respectOrientation']>().toEqualTypeOf<
            boolean | undefined
        >();
        expectTypeOf<DecodeOptions['normalizeColorProfile']>().toEqualTypeOf<
            boolean | undefined
        >();
    });

    it('animated is the union of handling modes', () => {
        expectTypeOf<DecodeOptions['animated']>().toEqualTypeOf<
            AnimatedHandling | undefined
        >();
    });

    it('svg is the union of handling modes', () => {
        expectTypeOf<DecodeOptions['svg']>().toEqualTypeOf<
            SvgHandling | undefined
        >();
    });
});
...
describe('ExtractColorsOptions', () => {
    ...
    it('groups remain independent — partial nested config does not clobber defaults', () => {
        const partial: ExtractColorsOptions = {
