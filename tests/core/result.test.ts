...
describe('MinimalExtractColorsResult', () => {
    it('requires primary as ExtractedColor', () => {
        expectTypeOf<
            MinimalExtractColorsResult['primary']
        >().toEqualTypeOf<ExtractedColor>();
    });

    it('requires secondary as ExtractedColor | null', () => {
        expectTypeOf<
            MinimalExtractColorsResult['secondary']
        >().toEqualTypeOf<ExtractedColor | null>();
    });
...
describe('ExtractColorsResult', () => {
    ...
    it('accents is an optional readonly ExtractedColor array', () => {
        expectTypeOf<ExtractColorsResult['accents']>().toEqualTypeOf<
            readonly ExtractedColor[] | undefined
        >();
    });

    it('palette is an optional readonly ExtractedColor array', () => {
        expectTypeOf<ExtractColorsResult['palette']>().toEqualTypeOf<
            readonly ExtractedColor[] | undefined
        >();
    });

    it('metadata is optional ExtractionMetadata', () => {
        expectTypeOf<ExtractColorsResult['metadata']>().toEqualTypeOf<
...
describe('ExtractionMetadata', () => {
    it('algorithm is the literal "lab-kmeans-chroma-weighted"', () => {
        expectTypeOf<
            ExtractionMetadata['algorithm']
        >().toEqualTypeOf<'lab-kmeans-chroma-weighted'>();
    });

    it('runtime is the union of three runtime names', () => {
        expectTypeOf<ExtractionMetadata['runtime']>().toEqualTypeOf<
            'browser' | 'node' | 'core'
        >();
    });
    ...
    it('fallbackUsed is a required boolean', () => {
        expectTypeOf<
            ExtractionMetadata['fallbackUsed']
        >().toEqualTypeOf<boolean>();
    });

    it('cacheVersion is a required string', () => {
        expectTypeOf<
            ExtractionMetadata['cacheVersion']
        >().toEqualTypeOf<string>();
    });

    it('packageVersion is optional', () => {
        expectTypeOf<ExtractionMetadata['packageVersion']>().toEqualTypeOf<
            string | undefined
        >();
    });
    ...
    it('numeric metrics are required numbers', () => {
        expectTypeOf<
            ExtractionMetadata['sampleSize']
        >().toEqualTypeOf<number>();
        expectTypeOf<
            ExtractionMetadata['sampledPixels']
        >().toEqualTypeOf<number>();
        expectTypeOf<
            ExtractionMetadata['validPixels']
        >().toEqualTypeOf<number>();
        expectTypeOf<ExtractionMetadata['clusters']>().toEqualTypeOf<number>();
        expectTypeOf<
            ExtractionMetadata['iterations']
        >().toEqualTypeOf<number>();
    });
