...
export type ColorExtractorErrorCode = (typeof COLOR_EXTRACTOR_ERROR_CODES)[number]

export class ColorExtractorError extends Error {
  readonly code: ColorExtractorErrorCode

  constructor(code: ColorExtractorErrorCode, message: string, options?: { cause?: unknown }) {
